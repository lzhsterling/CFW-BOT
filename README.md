...
ربات وورکر کلادفلر! بدون نیاز به سرور می‌تونید هر تعداد کانفیگ Xray بسازید،  به راحتی در [PythonAnywhere](https://www.pythonanywhere.com) اجرا میشه. یک مسیرکوتاه برای دسترسی به اینترنت آزاد✨
