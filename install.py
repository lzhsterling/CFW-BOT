...
set_key('.env', 'IP_API', 'https://raw.githubusercontent.com/cmliu/WorkerVless2sub/main/addressesapi.txt')
...
print("✔️ Environment Variables and Workertemp Updated. ✔️")
print("✔️ Now You Can Start CFW Bot ✔️")
print("🤍🤍 Women Life Freedom 🤍🤍")
